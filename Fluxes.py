...
def EpsRelationship():
    ...
    os.chdir(path_a4) # Changes working directory
    import FluxData_a4  # Import the script file
    Flux_Info_a4 = ReadAllData_a4()   # Read in all of the data flux data. This is the same for above.
    
    os.chdir(path_a09995) # Changes working directory
    import FluxData_a09995  # Import the script file
    Flux_Info_a09995 = ReadAllData_a09995()   # Read in all of the data flux data. This is the same for above.
        
    os.chdir(path_a5) # Changes working directory
    import FluxData_a5  # Import the script file
    ...
    Eps_a09995 = [(5/32) * 1 * ((r_a09995[i])**(3/2) + (1-10**-4))**(10/3)*Flux_a09995_GW[i] for i in range(0,len(Flux_Info_a09995))]
    ...
    Eps_a5 = [(5/32) * 1 * ((r_a5[i])**(3/2) + (1-10**-4))**(10/3)*Flux_a5_GW[i] for i in range(0,len(Flux_Info_a5))]
...
#
    ...
    return Rlist,CombineEpsThorne,Eps_97,r_97,Eps_998,r_998,Eps_999999999,r_999999999,r_a4,Eps_a4,r_a09995 ,Eps_a09995, r_a5,Eps_a5
def Extrapolate(a):
    ...
    """                
    Rlist,CombineEpsThorne,Eps_97,r_97,Eps_998,r_998,Eps_ext,r_ext,r_a4,Eps_a4,r_a09995 ,Eps_a09995, r_a5,Eps_a5 = EpsRelationship() # Unpack data values
...
Rlist,CombineEpsThorne,Eps_97,r_97,Eps_998,r_998,Eps_999999999,r_999999999,r_a4,Eps_a4,r_a09995 ,Eps_a09995, r_a5,Eps_a5 = EpsRelationship()  
